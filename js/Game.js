class Game {
  ...
  start() {
    ...
    var obstacle1Positions = [
      { x: 150, y: height - 1300, image: obstacle1Image },
      { x:250, y: height - 1800, image: obstacle1Image },
      { x: width / 2 - 180, y: height - 3300, image: obstacle1Image },
     
      { x: width  - 150, y: height - 4300, image: obstacle1Image },
      { x: width / 2, y: height - 5300, image: obstacle1Image },
    ];

    var obstacle2Positions = [
      { x: width  + 250, y: height - 800, image: obstacle2Image },
      { x: 180, y: height - 2300, image: obstacle2Image },
      { x: width / 2, y: height - 2800, image: obstacle2Image },
     
      { x: width / 2 + 180, y: height - 3300, image: obstacle2Image },
      { x: width  + 250, y: height - 3800, image: obstacle2Image },
      { x: width / 3+ 250, y: height - 4800, image: obstacle2Image },
